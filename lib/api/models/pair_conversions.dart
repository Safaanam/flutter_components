...
//
//     final pairConv = pairConvFromJson(jsonString);

import 'dart:convert';

PairConv pairConvFromJson(String str) => PairConv.fromJson(json.decode(str));

String pairConvToJson(PairConv data) => json.encode(data.toJson());
...
class PairConv {
  ...
  factory PairConv.fromJson(Map<String, dynamic> json) => PairConv(
    result: json["result"],
