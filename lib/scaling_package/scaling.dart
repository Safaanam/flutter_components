...
import 'package:flutter_components/scaling_package/widget/pinch_zoom.dart';

enum CompressMethods {imageCompress,nativeImage,luban}

class ScalingMethods extends StatefulWidget {
  const ScalingMethods({Key? key}) : super(key: key);

  @override
  _ScalingMethodsState createState() => _ScalingMethodsState();
}

class _ScalingMethodsState extends State<ScalingMethods> {
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                            ...
                            SizedBox(
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    const Text('Original image', style: TextStyle(
                      ...
                      // SizedBox(width: 10),
                      const Divider(height: 10, indent: 10, endIndent: 10, color: Colors.black26),
                            ...
                            SizedBox(
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const Text('Compressed image', style: TextStyle(
                                      fontWeight: FontWeight.bold, color: Colors.red,
                                    )),
                                    const SizedBox(height: 8),
                                    if (info2 != null) ...[
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      children: [
                        ...
                        Column(
                          children: [
                            Text('Quality (${_sliderValue.truncate()}%)', style: const TextStyle(fontWeight: FontWeight.bold)),
                            Slider(
                              value: _sliderValue,
                              min: 0,
                              max: 100,
  ...
  Widget _showInfoItem(String title, String subtitle) {
    return ListTile(
      title: Text(title),
      subtitle: Text(subtitle, style: const TextStyle(color: Colors.purple)),
      dense: true,
      contentPadding: EdgeInsets.zero,
...
class _ImageInfo extends GetxController {
  ...
  _ImageInfo.fromRaw(Uint8List raw) {
    getInfoFromRaw(raw);
    mimeType.value = const ListEquality().equals(headerBytes, _headerBytes['png'])
        ? 'image/png'
        : 'image/jpeg';
  }
  /* ---------------------------------------------------------------------------- */
