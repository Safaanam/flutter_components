...
import 'package:flutter_components/user_survey_kit/completed_page.dart';
import 'package:survey_kit/survey_kit.dart';
import 'package:flutter/material.dart';

/// survey_kit package from pub.dev

class SurveyModel extends StatefulWidget {
  const SurveyModel({Key? key}) : super(key: key);

  @override
  _SurveyModelState createState() => _SurveyModelState();
}

class _SurveyModelState extends State<SurveyModel> {
  @override
